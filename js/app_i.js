...
//Caso 1 Todas las respuestas correctas
		if (firstAnswer == correctAnswer1 && secondAnswer == correctAnswer2 && thirdAnswer == correctAnswer3) {
			document.getElementById("rightAnswers").innerHTML = "<img src='img/right.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas correctas fueron:<br /> <br />EL OPERADOR ! ES: <br /><br />" + firstAnswer + ": Es un operador binario que voltea el valor que se le dé; !true produce false y !false produce true. Representa Not (Negación)."+"<br /><br /> LA DIFERENCIA ENTRE UNDEFINED Y NULL* <br /><br />" + secondAnswer + ": Undefined significa que no se ha asignado un valor, mientras que null significa que hemos asignado el valor null."+ "<br /><br /> ¿CUÁLES son las 3 ETAPAS EN EL DESARROLLO DE UN PRODUCTO DIGITAL SEGÚN LABORATORIA? <br /><br />" + thirdAnswer+ ": Crecimiento, Diseño de la experiencia, Desarrollo.";
			document.getElementById("wrongAnswers").innerHTML = "<img src='img/wrong.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas incorrectas fueron:<br /><br /> Ninguna, ¡Eres genial y dentro de poco puedes ser una graduada de Laboratoria!";
			document.getElementById("imgTrivia").innerHTML = "<img src='img/laboratoria_1.jpeg' width='100%'' height='100%' />";
...
//Caso 2 Todas las respuestas incorrectas
			...
			document.getElementById("rightAnswers").innerHTML = "<img src='img/right.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas correctas fueron:<br /><br /> Ninguna, pero continúa aprendiendo <br />¡Tú puedes! :D";
			document.getElementById("wrongAnswers").innerHTML = "<img src='img/wrong.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas incorrectas fueron:<br /> <br />Pregunta 1.-EL OPERADOR ! ES: <br /><br /> La respuesta correcta es: <br /><br />" + correctAnswer1 + ": Un operador binario que voltea el valor que se le dé; !true produce false y !false produce true. Representa Not (Negación)." + "<br /><br /> Pregunta 2.- LA DIFERENCIA ENTRE UNDEFINED Y NULL* <br /><br /> La respuesta correcta es: <br /><br /> " + correctAnswer2 + ": Undefined significa que no se ha asignado un valor, mientras que null significa que hemos asignado el valor null.<br /> <br />" + " Pregunta 3.- ¿CUÁLES son las 3 ETAPAS EN EL DESARROLLO DE UN PRODUCTO DIGITAL SEGÚN LABORATORIA? <br /><br />  La respuesta correcta es: <br /><br />" + correctAnswer3 + ": Crecimiento, Diseño de la experiencia y Desarrollo.";
			document.getElementById("imgTrivia").innerHTML = "<img src='img/laboratoria_1.jpeg' width='100%'' height='100%' />";

//Caso 3 primera respuesta correcta, segunda y tercera inconrectas.
		} else if (firstAnswer == correctAnswer1 && secondAnswer != correctAnswer2 && thirdAnswer != correctAnswer3) {
			document.getElementById("rightAnswers").innerHTML = "<img src='img/right.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas correctas fueron:<br /> <br /> Pregunta 1. EL OPERADOR ! ES: <br /><br />" + firstAnswer + ": " + textAnswer3a;
...
//Caso 4 primera respusta mal, segunda correcta, tercera mal.
			...
			document.getElementById("rightAnswers").innerHTML = "<img src='img/right.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas correctas fueron:<br /><br /> Pregunta 2.- LA DIFERENCIA ENTRE UNDEFINED Y NULL* <br /><br />" + secondAnswer  + ": " + textAnswer2b;
...
//Caso 5 primera y segunda respuestas mal, tercera correcta
			...
			document.getElementById("rightAnswers").innerHTML = "<img src='img/right.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas correctas fueron:<br /><br /> Pregunta 3.- ¿CUÁLES son las 3 ETAPAS EN EL DESARROLLO DE UN PRODUCTO DIGITAL SEGÚN LABORATORIA? <br />Respuesta correcta: <br />" + thirdAnswer + ": " + textAnswer1c;
...
//Caso 6, Primera y segunda respuestas bien, tercera mal
			...
			document.getElementById("rightAnswers").innerHTML = "<img src='img/right.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas correctas fueron:<br /><br /> Pregunta 1.- EL OPERADOR ! ES <br />" + firstAnswer + ": " + textAnswer3a + "<br /><br /> Pregunta 2.- LA DIFERENCIA ENTRE UNDEFINED Y NULL*: <br />" + secondAnswer + ": " + textAnswer2b;
			document.getElementById("wrongAnswers").innerHTML = "<img src='img/wrong.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas incorrectas fueron:<br /><br /> Pregunta 3.- ¿CUÁLES son las 3 ETAPAS EN EL DESARROLLO DE UN PRODUCTO DIGITAL SEGÚN LABORATORIA? <br />"  + "<br /> Respuesta correcta: <br />" + correctAnswer3 + ": " + textAnswer1c;
			document.getElementById("imgTrivia").innerHTML = "<img src='img/laboratoria_1.jpeg' width='100%'' height='100%' />";

//Caso 7 Primera respuesta mal, segunda y tercera correctas
		} else if (firstAnswer != correctAnswer1 && secondAnswer == correctAnswer2 && thirdAnswer == correctAnswer3) {
			document.getElementById("rightAnswers").innerHTML = "<img src='img/right.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas correctas fueron:<br /><br /> Pregunta 2.- LA DIFERENCIA ENTRE UNDEFINED Y NULL*: <br />" + secondAnswer + ": " + textAnswer2b + "<br /><br /> Pregunta 3.- ¿CUÁLES son las 3 ETAPAS EN EL DESARROLLO DE UN PRODUCTO DIGITAL SEGÚN LABORATORIA? <br />" + thirdAnswer + ": " + textAnswer1c;
			document.getElementById("wrongAnswers").innerHTML = "<img src='img/wrong.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas incorrectas fueron:<br /><br /> Pregunta 1.- EL OPERADOR ! ES:  <br />" +  "<br /> Respuesta correcta: <br />" + correctAnswer1 + ": " + textAnswer3a;
			document.getElementById("imgTrivia").innerHTML = "<img src='img/laboratoria_1.jpeg' width='100%'' height='100%' />";

//Caso 8, Primera respuesta correcta, segunda inconrrecta, tercera correcta.
		} else if (firstAnswer == correctAnswer1 && secondAnswer != correctAnswer2 && thirdAnswer == correctAnswer3) {
			document.getElementById("rightAnswers").innerHTML = "<img src='img/right.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas correctas fueron:<br /><br /> Pregunta 1.- EL OPERADOR ! ES: <br />" + firstAnswer + ": " + textAnswer3a + "<br /><br /> Pregunta 3.- ¿CUÁLES son las 3 ETAPAS EN EL DESARROLLO DE UN PRODUCTO DIGITAL SEGÚN LABORATORIA? <br />" + thirdAnswer + ": " + textAnswer1c;
			document.getElementById("wrongAnswers").innerHTML = "<img src='img/wrong.png' width='50%'' height='50%' /> <br /> <br /> <br />" + "Tus respuestas incorrectas fueron:<br /><br /> Pregunta 2.- LA DIFERENCIA ENTRE UNDEFINED Y NULL* <br />" + "<br /> Respuesta correcta: <br />" + correctAnswer2 + ": " + textAnswer2b;
			document.getElementById("imgTrivia").innerHTML = "<img src='img/laboratoria_1.jpeg' width='100%'' height='100%' />";
		} 
